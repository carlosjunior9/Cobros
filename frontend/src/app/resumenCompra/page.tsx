  ...
  return (
    <div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        <h1 className="text-2xl font-bold text-left">Resumen de compra</h1>
      </div>
      ...
      <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">{nombreMostrar}</h2>
            {duracionMostrar && (
              <p className="text-sm text-gray-500 mt-1">Pago {duracionMostrar.toLowerCase()}</p>
            )}
          </div>
        </div>
      </div>
      ...
      {/* METODOS DE PAGO */}
      <div className="bg-white p-6 rounded-xl shadow-md">
        <h2 className="text-xl font-bold text-left mb-4">Métodos de pago</h2>
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                  metodoSeleccionado === 'qr' ? 'border-blue-500' : 'border-gray-300'
                }`}
              >
                {metodoSeleccionado === 'qr' && (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center py-1">
                    ...
                    <span className="font-medium text-gray-800">Bs. {formatearPrecio(iva)}</span>
                  </div>
